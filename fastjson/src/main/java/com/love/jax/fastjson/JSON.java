package com.love.jax.fastjson;


import com.love.jax.fastjson.deserializer.ObjectDeserializer;
import com.love.jax.fastjson.serializer.JSONSerializer;
import com.love.jax.fastjson.serializer.SerializeConfig;
...
public class JSON {
     ...
     * @return JavaBean对象
     */
    private static <T> T parseObject(String json,Class<T> clazz,SerializeConfig config) {
        // 参考源码JSON.java 350行
        if (json == null) {
            return null;
        }
