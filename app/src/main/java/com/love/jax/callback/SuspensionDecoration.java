...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#F4F6FC");
    private static int COLOR_TITLE_FONT = Color.parseColor("#4C5979");
    ...
    public SuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
       ...
       leftSize = ScreenUtil.dip2px(context,20f);
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft()+leftSize, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
...
//                    c.translate(0, child.getHeight() + child.getTop() - mTitleHeight);
        ...
        c.drawText(tag, child.getPaddingLeft()+leftSize,
