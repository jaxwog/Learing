...
import com.love.jax.callback.BaseIndexPinyinBean;
import com.love.jax.callback.IIndexBarDataHelper;
import com.love.jax.callback.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String index;//每个要绘制的index内容
        mPaint.setColor(Color.parseColor("#517DF7"));
        for (int i = 0; i < mIndexDatas.size(); i++) {
            index = mIndexDatas.get(i);
