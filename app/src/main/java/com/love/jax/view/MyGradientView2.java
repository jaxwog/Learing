...
/**
 * com.love.jax.view
 * Created by jax on 2020/7/11 14:31
 * TODO:
 */
public class MyGradientView2 extends View {
    ...
    public MyGradientView2(Context context) {
        super(context);
        mBitMap = ((BitmapDrawable)getResources().getDrawable(R.drawable.f1)).getBitmap();
        mPaint = new Paint();
        mWidth = mBitMap.getWidth();
        mHeight = mBitMap.getHeight();
    }

    public MyGradientView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mBitMap = ((BitmapDrawable)getResources().getDrawable(R.drawable.f1)).getBitmap();
        mPaint = new Paint();
        mWidth = mBitMap.getWidth();
