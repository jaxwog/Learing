...
/**
 * com.love.jax.utils copy from https://blog.csdn.net/xiaanming/article/details/12684155
 * Created by jax on 2018/11/14 15:41
 * TODO: 解析汉字为拼音
 */
public class CharacterParser {
    ...
    public int[] getArrLeg() {
        return arrLeg;
    }

    /**
     * 标记位，用来存放每个汉字对应的字母所占的长度
     */
    private int[] arrLeg;
