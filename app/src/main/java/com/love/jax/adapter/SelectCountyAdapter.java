 ...
 * TODO:适用于城市选择列表
 */
public class SelectCountyAdapter extends RecyclerView.Adapter<SelectCountyAdapter.SelectCityHolder>{
    ...
    public void setDatas(List<county> list){
        mList.clear();
...
//        viewHolder.mTitle.setText(Html.fromHtml(StringShowUtils.highLight(mList.get(position))));
        ...
        viewHolder.mTextView.setText(mList.get(position).getCountyName());
