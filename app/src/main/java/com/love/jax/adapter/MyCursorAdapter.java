...
public class MyCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        return inflater.inflate(R.layout.listview_item_loadmore, parent, false);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        dailBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_CALL, Uri.fromParts("tel", (String) v.getTag(), null));
        ...
        deleteBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int result = mContext.getContentResolver().delete(CallLog.Calls.CONTENT_URI, where, selectionArgs);
