...
public class JSON {
    private static final String TAG = "jaxJson";
    ...
    private static Object toObject(String json, Class<?> clazz, String basePackage, Map<String,
            String> map) {
    ...
    /**
     * @param json  JSONArray的字符串形式
     * @param clazz List内对象的class
     * @return
     */
...
/*                  JSONObject subObject = new JSONObject(jsonvalue);
     ...
     * @throws Exception
     */
    private static Object getFieldValue(Field field, JSONObject infoObject, String key,
                                        String basePackage, Map<String, String> map) throws Exception {
        Object fieldValue = null;
        ...
        } else if (fieldClass.getSimpleName().toString().equalsIgnoreCase("String")) {
...
//                      }
    ...
    private static void addObjectToBuffer(StringBuffer xmlBuffer, Object obj, String basePackage,
                                          boolean createClass) {
        xmlBuffer.append("{");
        // 获取所有属性
...
//                  xmlBuffer.append((DateFormatUtil.toTimeFormat((Date) fieldValue)));
                    xmlBuffer.append("\"");
                } else if (fieldValue instanceof Integer || fieldValue instanceof Double || fieldValue instanceof Long || fieldValue instanceof Boolean) {
                    xmlBuffer.append("\"");
    ...
    private static void addListToBuffer(StringBuffer xmlBuffer, Object fieldvalue,
                                        String basePackage, boolean createClass) {
        xmlBuffer.append("[");
